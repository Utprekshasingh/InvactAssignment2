...
//Endpoint 1
function sortHotelsByPricingAscending(hotel1, hotel2){
  return hotel1.price - hotel2.price;
}

function sortHotelsByPricingDescending(hotel1, hotel2){
...
app.get("/hotels/sort/pricing", (req, res) => {
  ...
  if(pricing === "low-to-high"){
    result.sort(sortHotelsByPricingAscending)
  }
  else{
    result.sort(sortHotelsByPricingDescending)
  }
  res.json({ hotels: result })
})

//Endpoint2
function sortHotelsByRatingAscending(hotel1, hotel2){
  return hotel1.rating - hotel2.rating;
}

function sortHotelsByRatingDescending(hotel1, hotel2){
...
app.get("/hotels/sort/rating", (req, res) => {
  ...
  if(rating === "low-to-high"){
    result.sort(sortHotelsByRatingAscending)
  }
  else{
    result.sort(sortHotelsByRatingDescending)
  }
  res.json({ hotels: result })
})

//Endpoint3
function sortHotelsByReviewAscending(hotel1, hotel2){
  return hotel1.reviews - hotel2.reviews;
}

function sortHotelsByReviewDescending(hotel1, hotel2){
...
app.get("/hotels/sort/reviews", (req, res) => {
  ...
  if(reviews === "least-to-most"){
    result.sort(sortHotelsByReviewAscending)
  }
  else{
    result.sort(sortHotelsByReviewDescending)
  }
  res.json({ hotels: result })
})
